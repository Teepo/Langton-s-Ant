...
var App = function (_Component) {
    ...
    _createClass(App, [{
        ...
        key: 'updateCurrentCell',
        value: function updateCurrentCell(state) {
            var _this3 = this;

            return new Promise(function (resolve) {
                _this3.currentCell.setState(state, resolve);
            });
        }
        ...
        key: 'updateCell',
        value: function updateCell(x, y, state) {
            var _this4 = this;

            return new Promise(function (resolve) {

                _this4.cells[x][y].setState(state, resolve);
            });
        }
        ...
        key: 'updateAnt',
        value: function updateAnt(state) {
            var _this5 = this;

            return new Promise(function (resolve) {

                _this5.ant.setState(state, resolve);
            });
        }
    }, {
        key: 'render',
        value: function render() {
            return (0, _preact.h)(
                'div',
                null,
                (0, _preact.h)(_Console.Console, { App: this }),
                (0, _preact.h)(_Grid.Grid, { App: this })
            );
        }
    }]);
...
var _Rows = __webpack_require__(3);
    ...
    _createClass(Grid, [{
        ...
        value: function render() {
            ...
            return (0, _preact.h)(
                'table',
                { className: 'grid' },
                (0, _preact.h)(_Rows.Rows, { App: this.props.App })
            );
        }
    }]);
...
var Rows = exports.Rows = function (_Component) {
        ...
        value: function render() {
            ...
            return (0, _preact.h)(
                ...
                [].concat(_toConsumableArray(Array(this.props.App.state.gridSize.x))).map(function (o, index) {
                    return (0, _preact.h)(_Row.Row, { key: index, x: index, App: _this2.props.App });
                })
            );
        }
    }]);
        ...
        value: function render() {
            ...
            return (0, _preact.h)(
                ...
                [].concat(_toConsumableArray(Array(this.props.App.state.gridSize.y))).map(function (o, index) {
                    return (0, _preact.h)(_Cell.Cell, { key: index, x: _this2.state.x, y: index, App: _this2.props.App });
                })
            );
        }
    }]);
    ...
    _createClass(Cell, [{
        ...
        value: function render() {
            ...
            return (0, _preact.h)(
                ...
                (0, _preact.h)(_Ant.Ant, { cell: this, App: this.props.App })
            );
        }
    }]);
...
var Ant = exports.Ant = function (_Component) {
    _inherits(Ant, _Component);
    ...
    _createClass(Ant, [{
        ...
        value: function render() {
            ...
            if (this.props.cell.state.coords.x === this.state.x && this.props.cell.state.coords.y === this.state.y || this.props.cell.state.antIsHere === true) {
            ...
            return (0, _preact.h)("div", { className: __antClassName });
        }
    }]);
...
var Console = exports.Console = function (_Component) {
    ...
    _createClass(Console, [{
        ...
        value: function updateZoom() {
            ...
            var value = document.querySelector('input[name="zoom"]').value;
                ...
                (0, _preact.h)(
                    ...
                    (0, _preact.h)(
                        ...
                        (0, _preact.h)(
                            ...
                            { className: 'coords' },
                            'X = ',
                            (0, _preact.h)('input', { type: 'number', name: 'x', value: App.state.gridSize.x, onChange: this.onChange.bind(this) }),
                            'Y = ',
                            (0, _preact.h)('input', { type: 'number', name: 'y', value: App.state.gridSize.y, onChange: this.onChange.bind(this) })
                        ),
                        (0, _preact.h)(
                            'div',
                            { className: 'controls' },
                            'ZOOM = ',
                            (0, _preact.h)('input', { type: 'number', name: 'zoom', onChange: this.onChangeZoom.bind(this), defaultValue: this.props.App.zoom }),
                            (0, _preact.h)('div', { className: playStateClassName, onClick: this.onPlayClickEvent.bind(this) }),
                            (0, _preact.h)('div', { className: 'stopState state', onClick: this.onStopClickEvent.bind(this) }),
                            (0, _preact.h)('div', { className: 'nextState state', onClick: this.onNextClickEvent.bind(this) })
                        )
                    )
                ),
                (0, _preact.h)(
